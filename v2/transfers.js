(() => {
  ...
  transferCreateDialog.innerHTML='<form method="dialog" class="inventory-head"><div><div class="transfer-kicker">Transfer</div><h2>Create transfer</h2></div><div class="inventory-actions"><button id="shopifyTransferCreateDraft" class="button" type="button">Create draft</button><button class="button secondary" type="submit">Close</button></div></form><section class="transfer-create-simple"><div class="transfer-create-route"><label>Transfer from<select id="shopifyTransferFrom" class="inventory-search" aria-label="From location"></select></label><label>Receiving location<select id="shopifyTransferTo" class="inventory-search" aria-label="To location"></select></label></div><div class="inventory-table-wrap"><table class="inventory-table"><thead><tr><th>SKU</th><th>Product</th><th>Quantity</th><th></th></tr></thead><tbody id="shopifyTransferDraftLines"></tbody></table></div><div class="transfer-create-add"><div class="product-lookup"><input id="shopifyTransferSku" class="inventory-search" autocomplete="off" placeholder="Search SKU or product"><div id="shopifyTransferSuggestions" class="product-suggestions" hidden></div></div><input id="shopifyTransferQuantity" class="inventory-search" type="number" min="1" step="1" placeholder="Qty"><button id="shopifyTransferAddLine" class="button secondary" type="button">Add line</button></div></section><p id="shopifyTransferCreateStatus" class="inventory-status">Choose the route, add the SKUs, then create the draft.</p>';
