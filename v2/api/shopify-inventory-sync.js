...
module.exports=async(req,res)=>{
 ...
 try{
  ...
  const query=`query($after:String){inventoryItems(first:25,after:$after){pageInfo{hasNextPage endCursor}nodes{id sku inventoryLevels(first:20){nodes{location{id} quantities(names:[\"on_hand\",\"available\",\"committed\"]){name quantity}}}}}}`;
