(() => {
  ...
  style.textContent=`.shopify-search-wrap{position:relative}.shopify-search-results{position:absolute;z-index:60;top:100%;left:0;right:0;background:#fff;border:1px solid var(--line);border-radius:12px;box-shadow:0 16px 40px rgba(15,23,42,.18);max-height:330px;overflow:auto;margin-top:4px}.shopify-search-item{display:grid;grid-template-columns:130px 1fr auto;gap:10px;width:100%;padding:11px 12px;border:0;border-bottom:1px solid var(--line);background:#fff;text-align:left}.shopify-search-item:hover{background:#f8fafc}.shopify-search-item:last-child{border-bottom:0}.shopify-search-sku{font-weight:900}.shopify-search-name{color:var(--muted)}.shopify-search-qty{font-weight:900;white-space:nowrap}.shopify-search-status{padding:12px;color:var(--muted);font-size:13px}@media(max-width:700px){.shopify-search-item{grid-template-columns:1fr}.shopify-search-qty{text-align:left}}`;
